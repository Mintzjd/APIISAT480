...
export default storyFactory({
  ...
  description:
    'The **Hello World Page** component is an example component ' +
    'that is meant to show you how to properly create, document, organize, ' +
    'and test a component in this app.',
})
...
const Template = (args, { argTypes }) => ({
  ...
  template: '<HelloWorld :greeting="greeting" />',
})
