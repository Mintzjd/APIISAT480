 ...
 */
const vmount = component => options => mount(component, { localVue, vuetify, mocks, ...options })
const vmountVuex = component => options => mount(component, { localVueWithVuex, vuetify, mocks, ...options })
const vshallowMount = component => options => shallowMount(component, { localVue, vuetify, mocks, ...options })
const vshallowMountVuex = component => options => shallowMount(component, { localVueWithVuex, vuetify, mocks, ...options })
